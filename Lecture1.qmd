...
## fHistory and Future of Antibiotic Therapy {background-color="#9B0014"}

<center>

Prof. Russell E. Lewis <br> Department of Molecular Medicine <br> University of Padua

<br> {{< fa solid envelope size=1x >}} russelledward.lewis\@unipd.it <br> {{< fa brands github size=1x >}} https://github.com/Russlewisbo <br> www.padovaid.com
...
1.  Describe key individuals in history of antibiotic discovery from the "empiric" versus "rational" schools

2.  Recognize major factors that have lead to a decrease in antibiotic discovery since the 1980s

3.  Discuss key reasons why advances in medical biotechnologies have not lead to major advances in antibiotics

4.  Describe new economic approaches approaches to de-link antibiotic payments
...
![](images/nubians.png){fig-align="center" width="600"}

[@nelson.etal_2010c]

## Paul Ehrlich (1854-1917) and the birth <br> of "modern" antibiotics {.smaller}
...
Side effects attributed to Salvarsan included rashes, liver damage, and risks of life and limb with extravasation- caused by improper handling and administration of the relatively toxic-insoluble compound
:::
:::::
...
::::: columns
::: {.column width="50%"}
<br> <br> ![](https://i.makeagif.com/media/7-05-2015/V0HT6G.gif)
:::
...
## Gerhard Domagk (1895-1964): <br> Discovery of sulfonamides {.smaller}
...
::: aside
Images: Welcome collection
:::

## First animal testing of penicillin
...
-   It was difficult to ferment enough crude peniciilin
-   Heatley’s inventiveness shown both in this device and in his design of a dish to grow the mould at an experimental scale allowed early clinical studies
:::
:::::

::: aside
Images: Oxford University Archives
:::
...
![](images/response1.png){width="600"}
...
## Winston Churchill's life saved with <br> sulfapyridine in 1943
...
## Structure of penicillin {.smaller}

::::: columns
::: {.column width="40%"}
![](images/Hodgekin.png){width="500"}
:::
...
## First reports of penicillin resistance {.smaller}

<br>

![](images/pcnr.png){fig-align="center" width="600"}
...
-   Bronzu performed epidemiological studies of typhoid infection in Cagliari,- he noted *Salmonella typhi* was not cultured once sewer water was discharged into the sea
...
## First effective therapies for tuberculosis {.smaller}
...
![](images/void.png){fig-align="center" width="600"}
...
![](images/dereplication.png){fig-align="center"}

## 1970’s: The Shift from empirical to <br> “rational” discovery

<br>

-   Attempts to overcome the increasing work of de-replication with fewer possibilities for novel compound discovery
...
## β-lactamase inhibitors {.smaller}

![](images/beta-lactamases.png){fig-align="center" width="1000"}
...
::::: columns
::: {.column width="50%"}
![](images/science.png){width="350"}
:::

::: {.column width="50%"}
![](images/sequencing.png){width="350"}
:::
:::::
...
## ...but the crises continued {.smaller}

<center>![](images/void.png){width="600"}</center>
...
![](images/payne.png){fig-align="center" width="500"}
...
![](images/logd.png){fig-align="center"}
...
-   Experience gained from 30 years of failure:
    ...
    -   Bacterial cell penetration, transport, cellular efflux and protein binding is increasing rapidly

    -   Use of more “druggable” chemical libraries
...
## Antibiotic economic model: Pull incentives

<br>

<center>![](images/netflix.png){fig-align="center"}</center>

## Subscription models: First approval in Italy

![](images/ITA_subscription.png){fig-align="center"}

## Summary

<br>

-   The parallel problems of increasing antibiotic resistance and lack of *novel* antibiotic development is a growing health crises
-   Two schools of antibiotic discovery: *empirical* vs. *rational* : each has their converts
-   Biotechnological advances have largely failed to deliver new antibiotics, especially for gram-negative pathogens
-   The economics of antibiotic discovery, development and use require new approaches to ensure that antibiotics are available for future generations
